...
import { 
  ...
  FaDumbbell, FaCheckCircle, FaTrash, FaPlus, FaTasks
} from 'react-icons/fa';
...
const ChallengeIcon = ({ icon, color }) => {
  switch(icon) {
    case "FaTasks":
      return <FaTasks className="challenge-icon" style={{ color }} />;
    case "FaDumbbell":
    default:
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaTasks className="challenge-icon" style={{ color: challenge.color }} />
