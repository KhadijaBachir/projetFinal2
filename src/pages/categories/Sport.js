...
const Sport= () => {
  ...
  const generateDefaultChallenges = () => {
    const baseChallenges = [
      ...
      {
        id: " xZ9TpQfLJpQmN2FyErt5 ",
        name: "Gainage",
        description: "Tiens la position le plus longtemps possible",
        icon: "FaStopwatch",
        points: 5
      },
      {
        id: " vQkM2rXwPz3Y8LsHga10 ",
        name: "Sauts en étoile",
        description: "Réveille ton cardio avec 30 jumping jacks",
        icon: "FaHeartbeat",
        points: 5
      }
    ...
    <div style={{ backgroundColor: "#ff6f61", minHeight: "100vh", overflowX: "hidden" }}>
     {/* Navbar */}
      ...
      <Container>
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaDumbbell className="challenge-icon" style={{ color: challenge.color }} />
        ...
        {/* Défis utilisateur */}
        <h2 className="section-title">Mes Défis Sports</h2>
        <Row>
        ...
        <Row className="mt-5">
          <Col md={6} className="mx-auto">
            <Card className="form-card">
              <Card.Body>
                <h3 className="text-center">Ajouter un défi sport</h3>
                <Form>
