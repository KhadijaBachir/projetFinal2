...
import { 
  ...
  FaDumbbell, FaCheckCircle, FaTrash, FaPlus, FaHandHoldingHeart   
} from 'react-icons/fa';
...
const bienetreImagePath = '/devdev.avif';

// Ajoutez ce composant juste ici
const ChallengeIcon = ({ icon, color }) => {
  switch(icon) {
    case "FaHandHoldingHeart ":
      return <FaHandHoldingHeart  className="challenge-icon" style={{ color }} />;
    case "FaDumbbell":
    default:
...
{/* Navbar */}
      ...
      <Container>
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaHandHoldingHeart className="challenge-icon" style={{ color: challenge.color }} />
        ...
        {/* Défis utilisateur */}
        <h2 className="section-title">Mes Défis Developpement Personnel</h2>
        <Row>
        ...
        <Row className="mt-5">
          <Col md={6} className="mx-auto">
            <Card className="form-card">
              <Card.Body>
                <h3 className="text-center">Ajouter un défi de developpement personnel</h3>
                <Form>
