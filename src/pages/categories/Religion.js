...
import { 
  ...
  FaDumbbell, FaCheckCircle, FaTrash, FaPlus, FaPrayingHands  
} from 'react-icons/fa';
...
const bienetreImagePath = '/reli.jpg';

// Ajoutez ce composant juste ici
const ChallengeIcon = ({ icon, color }) => {
  switch(icon) {
    case "FaPrayingHands":
      return <FaPrayingHands className="challenge-icon" style={{ color }} />;
    case "FaDumbbell":
    default:
  ...
  return (
    <div style={{ backgroundColor: "#ff6f61", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <Container>
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaPrayingHands className="challenge-icon" style={{ color: challenge.color }} />
        ...
        {/* Défis utilisateur */}
        <h2 className="section-title">Mes Défis Religion</h2>
        <Row>
        ...
        <Row className="mt-5">
          <Col md={6} className="mx-auto">
            <Card className="form-card">
              <Card.Body>
                <h3 className="text-center">Ajouter un défi Religion</h3>
                <Form>
