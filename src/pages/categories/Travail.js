...
import { 
  ...
  FaDumbbell, FaCheckCircle, FaTrash, FaPlus, FaBriefcase  
} from 'react-icons/fa';
...
const bienetreImagePath = '/travail.jpg';

// Ajoutez ce composant juste ici
const ChallengeIcon = ({ icon, color }) => {
  switch(icon) {
    case "FaBriefcase":
      return <FaBriefcase className="challenge-icon" style={{ color }} />;
    case "FaDumbbell":
    default:
...
const Travail = () => {
  ...
  const generateDefaultChallenges = () => {
    const baseChallenges = [
      ...
      {
        id: "Abc123Work01",
        name: "Travailler sans distraction pendant 1h",
        description: "Concentration maximale sans téléphone ni réseaux",
        icon: "FaBriefcase",
        points: 5
      },
      {
        id: "Mno345Work05",
        name: "Envoyer un message de remerciement à un collègue",
        description: "Reconnaître les efforts des autres au travail",
        icon: "FaBriefcase",
        points: 5
      }
  ...
  return (
    <div style={{ backgroundColor: "#ff6f61", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <Container>
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaBriefcase className="challenge-icon" style={{ color: challenge.color }} />
        ...
        {/* Défis utilisateur */}
        <h2 className="section-title">Mes Défis Travail</h2>
        <Row>
        ...
        <Row className="mt-5">
          <Col md={6} className="mx-auto">
            <Card className="form-card">
              <Card.Body>
                <h3 className="text-center">Ajouter un défi travail</h3>
                <Form>
