...
import { 
  ...
  FaDumbbell, FaCheckCircle, FaTrash, FaPlus, FaAppleAlt  
} from 'react-icons/fa';
...
const bienetreImagePath = '/nutrition.jpg';

// Ajoutez ce composant juste ici
const ChallengeIcon = ({ icon, color }) => {
  switch(icon) {
    case "FaAppleAlt":
      return <FaAppleAlt className="challenge-icon" style={{ color }} />;
    case "FaDumbbell":
    default:
...
const  Nutrition = () => {
  ...
  const generateDefaultChallenges = () => {
    const baseChallenges = [
      ...
      {
        id: " JYtZ93eKm4cPvT1rLoAa ",
        name: "Préparer un repas équilibré",
        description: "Cuisiner un plat sain avec légumes et protéines",
        icon: "FaAppleAlt",
        points: 5
      },
      {
        id: " URf65lNkKzBxV8cQoMht ",
        name: "Faire une journée sans soda",
        description: "Remplacer les boissons sucrées par de l'eau ou des infusions",
        icon: "FaAppleAlt",
        points: 5
      },
      {
        id: " WNm73lXzOfLyB9sVu3Ki ",
        name: "Manger sans grignoter entre les repas",
        description: "Défi pour adopter de bonnes habitudes alimentaires",
        icon: "FaAppleAlt",
        points: 5
      }
  ...
  return (
    <div style={{ backgroundColor: "#ff6f61", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <Container>
            ...
            <Col md={4} key={challenge.id} className="mb-4">
              ...
              >
                <Card.Body className="text-center">
                  <FaAppleAlt className="challenge-icon" style={{ color: challenge.color }} />
        ...
        {/* Défis utilisateur */}
        <h2 className="section-title">Mes Défis Nutritions</h2>
        <Row>
        ...
        <Row className="mt-5">
          <Col md={6} className="mx-auto">
            <Card className="form-card">
              <Card.Body>
                <h3 className="text-center">Ajouter un défi nutrition</h3>
                <Form>
